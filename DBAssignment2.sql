...
INSERT INTO dependents(dependent_id,first_name,last_name,relationship,employee_id) VALUES (30,'Sandra','Taylor','Child',176);
 ...
 /* Question1 */
select  first_name, last_name from employees e join departments d on d.department_id =e.department_id 
join locations l on d.location_id=l.location_id join countries c on l.country_id=c.country_id
where e.salary > 10000 and e.hire_date > 1998-12-31 and not(e.department_id= 1) and(c.country_id= 'CA'or c.country_id='AU');

/* Question2 */
select *from employees  where  job_id in (3,6) order by salary desc limit 0,6 ;
/* Quetion3 */
select dependents.dependent_id, employees.employee_id , salary
from dependents dependents
inner join employees on dependents.employee_id = employees.employee_id  where salary between 10000 and 20000;
